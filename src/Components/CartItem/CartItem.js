...
//                     <h3>${GetTotalCartAmount()}</h3>
//                 </div>
//                 <Link to="/Login"><button className="btn btn-primary my-3" style={{background:"#ff4141" ,outline:"none" ,border:"none"}}>Proceed to CheckOut</button></Link>
//             </div>
//             <div className="cartitems-promocode mb-4">
//                 <p>if you have promocode, Enter it here</p>
//                 <div className="cartitems-promobox">
//                     <input type="text" className="form-control my-3" placeholder='Promo code' />
//                     <button className="btn btn-primary w-100" style={{background:"#ff4141" ,outline:"none" ,border:"none"}}>Submit</button>
//                 </div>
//             </div>
//         </div>
//     );
